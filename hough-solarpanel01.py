...
def main(argv):
    ...
    # Loads an image
    src = cv.imread("DC_0161.jpg", cv.IMREAD_GRAYSCALE)
    ...
    lines = cv.HoughLines(dst, 1, np.pi / 180, 500, 500, 0, 0)
...
cv2.imwrite(timestr+'cdst.jpg',cdst)
cv2.imwrite(timestr+'cdstP.jpg',cdstP)