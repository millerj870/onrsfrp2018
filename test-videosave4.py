...
def main():
	...
	# setting isColor=False
	if not vw.open(timestr+'-vidtest.mp4',fourcc,fps,size,False):
	...
	while True:
		...
		# 180719 fails when I transform the frames to grayscale
		# 180719 was failing (it appears) becasue VideoWrter was expdcting a color video; changed isColor to False
		# 	and it works (SO #48976002)
		frame = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
		frame = cv2.Canny(frame,180,200,10)
